...
----
sudo apt-get update
sudo apt-get install --yes python3.8 python3.8-dev python3.8-venv
----
...
[source,sh]
----
venv/bin/python pip install --upgrade pip setuptools wheel
----
...
[source,sh]
----
venv/bin/python pip install tflite-runtime librosa resampy
----
...
[source,sh]
----
venv/bin/python pip install TensorFlow>=2.5.0 librosa resampy
----

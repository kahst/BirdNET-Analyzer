...
Watch our presentation on how to use BirdNET-Analyzer to train your own models: https://youtu.be/HuEZGIPeyq0?si=yqHohYDYGLJqyY_-[BirdNET - BioacousTalks at YouTube]

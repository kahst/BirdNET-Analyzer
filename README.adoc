...
| *faunanet* + 
faunanet is an extension of Birdnet-Analyzer, and uses birdnetlib as its basis. faunanet provides a platform for bioacoustics research projects, started at the Interdisciplinary center for scientific computing at the University of Heidelberg.

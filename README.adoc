...
https://tuc.cloud/index.php/s/YY3Erjad6ytWYJw[*Click here to download the Windows installer*] and follow the https://github.com/kahst/BirdNET-Analyzer#setup-windows[setup instructions].
...
| image:https://github.com/tphakala/go-birdnet/raw/main/doc/go-birdnet-logo.webp[Go-BirdNET,300,link=https://github.com/tphakala/go-birdnet]
| *Go-BirdNET* +
...
You can download this version here: https://tuc.cloud/index.php/s/YY3Erjad6ytWYJw[BirdNET-Analyzer Windows]

. Download the https://tuc.cloud/index.php/s/YY3Erjad6ytWYJw[*BirdNET-Analyzer-setup.exe*] file

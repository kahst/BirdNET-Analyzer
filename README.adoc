...
| *Chirpity* +
Chirpity is a desktop application available for Windows, Mac and Linux platforms. Optimised for speed and ease of use, it can analyse anything from short clips to hundreds of hours of audio with unparalleled speed. Detections can be validated against reference calls, edited and saved to a call library.  Results can also be exported to a variety of formats including CSV, Raven and eBird.

...
You can download this version here: https://github.com/kahst/BirdNET-Analyzer/releases/download/v1.1.0/BirdNET-Analyzer-GUI-1.1.0.exe[BirdNET-Analyzer Windows]

. Download the https://github.com/kahst/BirdNET-Analyzer/releases/download/v1.1.0/BirdNET-Analyzer-GUI-1.1.0.exe[*BirdNET-Analyzer-setup.exe*] file

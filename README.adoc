...
| image:https://github.com/ecomontec/ecoSound-web/blob/master/src/assets/images/biosounds_logo_large.png[ecoSound-web,300,link=https://ecosound-web.de/ecosound_web/]
| *ecoSound-web* + 
ecoSound-web is a web application for ecoacoustics to manage, re-sample, navigate, visualise, annotate, and analyse soundscape recordings. It can execute BirdNET on recording batches and is currently being developed at INRAE, France.

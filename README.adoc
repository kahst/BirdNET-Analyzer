...
The default language of the GUI is English, but you can change it to German, French or Chinese in the *Settings* tab of the GUI. If you want to contribute a translation to another language you, use the files inside the `lang` folder as a template. You can then send us the translated files or create a pull request.

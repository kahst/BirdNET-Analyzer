...
| *Chirpity Nocmig* +
Chirpity Nocmig uses cutting-edge Machine Learning to identify bird calls in both long audio recordings and shorter clips. 
It supports various audio formats including WAV, MP3, OGG, and M4A.

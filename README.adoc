...
|===
| image:{mail-badge}[Email, link=mailto:ccb-birdnet@cornell.edu]
|Want to use BirdNET to analyze a large dataset?
Don't hesitate to contact us: ccb-birdnet@cornell.edu

|image:https://img.shields.io/twitter/follow/BirdNET_App[Twitter Follow, link=https://twitter.com/BirdNET_App]
|Follow us on Twitter.

|image:{reddit-badge}[Subreddit subscribers, link="https://reddit.com/r/BirdNET_Analyzer"]

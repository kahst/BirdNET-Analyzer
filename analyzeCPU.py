...
def getRawAudioFromFile(fpath, offset, duration):
...
def analyzeFile(item):
    ...
    try:
        ...
        while True: 
            ...
            #print("loading chunk: " + fpath + " offset: " + str(offset))
            ...
            delta_time = (datetime.now() - start_time2).total_seconds()
            #print('finished resamp:' + str(delta_time))
            #chunks = getRawAudioFromFile(fpath,offset, duration)
            ...
            #print('Finished {} batch prediction in {:.2f} seconds'.format(fpath, delta_time), flush=True)
